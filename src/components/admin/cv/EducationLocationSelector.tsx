...
export function EducationLocationSelector({ 
  ...
  const handleProvinciaChange = (value: string) => {
    ...
    setLocalidadess([]);
    onChange(educacionId, { provincia: value, municipio: "", localidad: "" });
  };

  const handleDepartamentoChange = (value: string) => {
    setSelectedDepartamento(value);
    setSelectedLocalidad("");
    onChange(educacionId, { provincia: selectedProvincia, municipio: value, localidad: "" });
  };

  const handleLocalidadChange = (value: string) => {
    setSelectedLocalidad(value);
    onChange(educacionId, { provincia: selectedProvincia, municipio: selectedDepartamento, localidad: value });
  };
